# language: pt
@ContaTest
Funcionalidade: Testar as operações básicas da conta
  O sistema de prover o saque e deposito na conta de forma correta.
  ...
  Esquema do Cenário: Testar saque e deposito
    ...
    Exemplos:
      ...
      | Dijalma | 111    | 1000   | 0     | 100      | 10             | 10            | 80             |
      | Jose    | 222    | 1000   | 0     | 200      | 10             | 10            | 180            |